...
class Page:
    ...
    def wait_until_clickable_click(self, *locator):
        self.wait.until(
            EC.element_to_be_clickable(locator),
                        f'ERROR!!! Element is not clickable by {locator}'
        ).click()

    def wait_until_visible(self, *locator):
        self.wait.until(
            EC.visibility_of_element_located(locator),
                        f'ERROR!!! Element is not visible by {locator}'
        )

    def wait_until_disappears(self, *locator):
        self.wait.until(
            EC.invisibility_of_element_located(locator),
                        f'ERROR!!! Element still visible by {locator}'
        )
    ...
    def verify_text(self, expected_text, *locator):
        ...
        assert actual_text == expected_text, \
            f'ERROR!!! Text {expected_text} not in {actual_text}'
    ...
    def verify_partial_url(self, expected_partial_url):
        self.wait.until(
            EC.url_contains(expected_partial_url),
                        f'ERROR!!! URL does not contain {expected_partial_url}'
        )

    def verify_url(self, expected_url):
        self.wait.until(EC.url_matches(expected_url),
                        f'ERROR!!! URL does not contain {expected_url}')
